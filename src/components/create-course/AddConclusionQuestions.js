...
export default function AddConclusionQuestions({
  id,
  videoIndex,
  setIsAddConclusionQuestionsOpen,
}) {
  const {
    conclusionVideos,
    addConclusionVideoQuestions,
    addConclusionQuestionOptions,
    removeConclusionVideoQuestions,
    removeConclusionQuestionOptions,
    updateQuestionText,
    updateQuestionImage,
    updateOptionText,
    updateOptionImage,
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 bg-black/40 flex justify-center items-center px-2 py-6">
      <div className="relative w-full max-w-5xl max-h-[90vh] bg-[var(--background-primary)] rounded-2xl overflow-hidden flex flex-col">
        ...
        <button
          type="button"
          onClick={() => setIsAddConclusionQuestionsOpen(false)}
        ...
        <div className="w-full bg-[var(--background-primary)] px-14 pb-4 flex flex-col gap-6">
          ...
          <div className="flex justify-center pt-2">
            <button
              ...
              onClick={() => addConclusionVideoQuestions(videoIndex)}
            >
              + Add a question
            </button>
          </div>
