...
// export default function UploadToVimeo({ videoTitle = "", onClose }) {
...
//           // Step 3: Poll Vimeo to check when optimization is done
//           try {
...
//                 setIsUploading(false);
//               } else {
//                 setTimeout(checkOptimization, 30000); // retry every 3s
//               }
//             };
...
//             alert("Error checking optimization status");
//             setIsUploading(false);
//           }
//         },
//       });
...
//   return createPortal(
//     <div className="fixed inset-0 z-50 bg-black/40 flex justify-center items-center px-2 py-6">
//       <div className="relative w-full max-w-4xl max-h-[90vh] bg-[var(--background-primary)] rounded-2xl overflow-hidden flex flex-col p-6 space-y-4">
//         {/* Close Button */}
//         <button
//           type="button"
//           onClick={() => onClose(false)}
//           className="absolute top-3 right-3 size-9 rounded-lg bg-[#DF5050] text-white flex justify-center items-center z-10 cursor-pointer disabled:opacity-50"
...
//         {uploadProgress > 0 && <p>Uploading: {uploadProgress}%</p>}
//         {isOptimizing && <p>Optimizing... (This may take a minute)</p>}
//         {videoUrl && (
//           <div>
