...
// export default function VideoTranscript({ video, onFileChange, onClose }) {
...
//             id="srt"
//             accept=".srt"
//             onChange={(e) => handleSrtFileChange(e)}
//             className="hidden"
//           />

//           {(video?.srt?.name || video?.videoTranscript) && (
...
//                   {video?.srt?.name ? video?.srt?.name : video?.videoTranscript}
//                 </span>
//               </p>
//               <button
//                 type="button"
